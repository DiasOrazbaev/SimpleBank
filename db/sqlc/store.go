...
// TransferTxParams contains the input arguments of the transfer transaction
...
// In creates a transfer record, add account entries, add update account's balance within a single db transaction
